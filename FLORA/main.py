...
if not params['kb1'] is None and not params['kb2'] is None:
    kb1 = utils.graphFromTurtleFile(params['kb1'])
    kb2 = utils.graphFromTurtleFile(params['kb2'])
elif 'OpenEA' in params['dataset']:
...
if params['kb1'] is None or params['kb2'] is None:
